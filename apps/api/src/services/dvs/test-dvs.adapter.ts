...
export interface TestDvsAdapterConfig {
  apiUrl?: string;
  apiKey?: string;
  clientSecret?: string;
  timeoutMs?: number;
...
export class TestDvsAdapter implements IDvsProviderAdapter {
  public readonly providerName = "TEST_DVS";
  private config: TestDvsAdapterConfig;

  constructor(configOverrides?: Partial<TestDvsAdapterConfig>) {
    this.config = {
